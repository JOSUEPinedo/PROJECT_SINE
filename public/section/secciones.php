...
<script>
    function openActionModal(sectionId, actionType) {
        ...
        if (actionType === 'productos') {
            $.ajax({
                url: '../product/add_producto.php', // URL del archivo que quieres cargar
                type: 'GET',
            ...
            $.ajax({
                url: '../register/add_registro.php', // URL del archivo que quieres cargar
                type: 'GET',
                success: function(data) {
                    $('#modalContent').html(data); // Cargar el contenido del archivo en el modal
                    $('#actionModal').modal('show'); // Mostrar el modal
    ...
    function submitForm() {
        ...
        $.post('perform_action.php', formData, function(response) {
            ...
            if (response.status === 'success') {
                ...
                window.location.href = '../product/productos.php'; // Redirigir a productos.php
            }
        }, 'json');
    }
</script>
